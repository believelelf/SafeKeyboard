...
public class VerifyMessageDigestAspect {
    ...
    public void verifyMessageDigest(JoinPoint joinPoint, Object req) {
        ...
        VerifyMessageDigest verifyMessageDigest = ((MethodSignature) joinPoint.getSignature()).getMethod().getAnnotation(VerifyMessageDigest.class);
        AppSecretUtil.verifyMessageDigest(appSecret, req, verifyMessageDigest.needUrlEncoding());
    }
}
