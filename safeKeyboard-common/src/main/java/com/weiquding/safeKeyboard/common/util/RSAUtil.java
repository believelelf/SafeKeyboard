...
public class RSAUtil {
    ...
    public static byte[] signByRSAPrivateKey(RSAPrivateKey privateKey, byte[] data) {
        try {
            ...
            throw new CipherRuntimeException("An error occurred while signing with RSAPrivateKey", e);
        }
    }
    ...
    public static boolean verifySignByRSAPublicKey(RSAPublicKey publicKey, byte[] data, byte[] sign) {
        try {
            ...
            throw new CipherRuntimeException("An error occurred while using RSAPublicKey to verify the signature", e);
        }
    }
