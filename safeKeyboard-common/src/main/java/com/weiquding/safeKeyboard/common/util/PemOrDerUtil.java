...
public class PemOrDerUtil {
    ...
    public static PrivateKey readPEMRSAPrivateKeyByPEMParser(String fileName, String password) {
        ...
        try (
            ...
            throw new CipherRuntimeException("An error occurred reading the RSAPrivateKey from the pem file", e);
        }
    }
    ...
    public static PublicKey readPEMRSAPublicKeyByPEMParser(String fileName) {
        ...
        try (
            ...
            throw new CipherRuntimeException("An error occurred reading the RSAPublicKey from the pem file", e);
        }
    }
    ...
    public static PrivateKey readUnencryptedPKCS8DERRSAPrivateKey(String fileName) {
        try {
            ...
            throw new CipherRuntimeException("An error occurred reading the RSAPrivateKey from the der file", e);
        }
    }
    ...
    public static PublicKey readUnencryptedPKCS8DERRSAPublicKey(String fileName) {
        try {
            ...
            throw new CipherRuntimeException("An error occurred reading the RSAPublicKey from the der file", e);
        }
    }
